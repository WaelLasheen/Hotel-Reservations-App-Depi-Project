  ...
  List<Hotel> getAllHotels() {
    return [
      Hotel(
        ...
        description: 'Luxury hotel in the heart of Cairo with stunning Nile views.',
      ),
      Hotel(
        id: '2',
      ...
      Hotel(
        ...
        rating: 4.7,
        reviewCount: 278,
        facilities: ['Wi-Fi', 'Private Beach', 'Spa', 'Diving Center', 'Multiple Restaurants'],
        description: 'Luxury resort with world-class diving and beach activities.',
      ),
      Hotel(
        id: '9',
